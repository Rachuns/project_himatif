    ...
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
                ...
                <span><img width="40px" style="margin-right:10px" src="{{asset('/himatif')}}/logohima.png" alt=""></span>
                <div class="logo-text">
                    <span class="logo-title" style="margin-bottom:10px">HIMATIF</span>
                    <span class="logo-subtitle"></span>
                </div>

            </a>
            <button class="sidebar-toggle transparent-btn" style="margin-bottom: 10px" title="Menu" type="button">
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon document" aria-hidden="true"></span>Postingan
                    ...
                    <ul class="cat-sub-menu">
                        ...
                        <li>
                            <a href="new-post.html">Visi Misi</a>
                        </li>
                        <li>
                          <a href="new-post.html">Testimoni Alumni</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon folder" aria-hidden="true"></span>Kepengurusan
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
    ...
    <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
            <span class="sidebar-user-img">
                <picture><source srcset="{{asset('backendelegant')}}/img/avatar/avatar-illustrated-01.webp" type="image/webp"><img src="{{asset('backendelegant')}}/img/avatar/avatar-illustrated-01.png" alt="User name"></picture>
            </span>
      ...
      <div class="nav-user-wrapper">
        <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
          ...
          <span class="nav-user-img">
            <picture><source srcset="{{asset('backendelegant')}}/img/avatar/avatar-illustrated-02.webp" type="image/webp"><img src="{{asset('backendelegant')}}/img/avatar/avatar-illustrated-02.png" alt="User name"></picture>
          </span>
        </button>
